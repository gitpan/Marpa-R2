...
#define ISY_Count_of_G(g) (DSTACK_LENGTH((g) ->t_symbols) ) 
...
#define IRL_Count_of_G(g) (DSTACK_LENGTH((g) ->t_rules) ) 
#define XRL_Count_of_G(g) (DSTACK_LENGTH((g) ->t_rules) ) 
