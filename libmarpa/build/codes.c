...
const struct s_marpa_error_description marpa_error_description[] = {
  ...
  { 21, "MARPA_ERR_INVALID_START_SYMBOL", "Specified start symbol is not valid" },
  ...
  { 25, "MARPA_ERR_MAJOR_VERSION_MISMATCH", "Libmarpa major version number is a mismatch" },
  { 26, "MARPA_ERR_MICRO_VERSION_MISMATCH", "Libmarpa micro version number is a mismatch" },
  { 27, "MARPA_ERR_MINOR_VERSION_MISMATCH", "Libmarpa minor version number is a mismatch" },
  ...
  { 36, "MARPA_ERR_NO_START_SYMBOL", "This grammar has no start symbol" },
  ...
  { 42, "MARPA_ERR_ORDER_FROZEN", "The ordering is frozen" },
  { 43, "MARPA_ERR_ORID_NEGATIVE", "MARPA_ERR_ORID_NEGATIVE" },
  { 44, "MARPA_ERR_OR_ALREADY_ORDERED", "MARPA_ERR_OR_ALREADY_ORDERED" },
  { 45, "MARPA_ERR_PARSE_EXHAUSTED", "The parse is exhausted" },
  { 46, "MARPA_ERR_PARSE_TOO_LONG", "This input would make the parse too long" },
  ...
  { 51, "MARPA_ERR_RECCE_NOT_ACCEPTING_INPUT", "The recognizer is not accepting input" },
  { 52, "MARPA_ERR_RECCE_NOT_STARTED", "The recognizer has not been started" },
  { 53, "MARPA_ERR_RECCE_STARTED", "The recognizer has been started" },
  { 54, "MARPA_ERR_RHS_TOO_LONG", "The RHS is too long" },
  ...
  { 64, "MARPA_ERR_TOKEN_IS_NOT_TERMINAL", "Token symbol must be a terminal" },
  { 65, "MARPA_ERR_TOKEN_LENGTH_LE_ZERO", "Token length must greater than zero" },
  { 66, "MARPA_ERR_TOKEN_TOO_LONG", "Token is too long" },
  { 67, "MARPA_ERR_TREE_EXHAUSTED", "Tree iterator is exhausted" },
  { 68, "MARPA_ERR_TREE_PAUSED", "Tree iterator is paused" },
