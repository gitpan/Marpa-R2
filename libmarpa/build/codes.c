...
const struct s_marpa_error_description marpa_error_description[] = {
  ...
  { 24, "MARPA_ERR_MAJOR_VERSION_MISMATCH", "MARPA_ERR_MAJOR_VERSION_MISMATCH" },
  { 25, "MARPA_ERR_MICRO_VERSION_MISMATCH", "MARPA_ERR_MICRO_VERSION_MISMATCH" },
  { 26, "MARPA_ERR_MINOR_VERSION_MISMATCH", "MARPA_ERR_MINOR_VERSION_MISMATCH" },
  { 27, "MARPA_ERR_NOT_PRECOMPUTED", "MARPA_ERR_NOT_PRECOMPUTED" },
  { 28, "MARPA_ERR_NOT_TRACING_COMPLETION_LINKS", "MARPA_ERR_NOT_TRACING_COMPLETION_LINKS" },
  { 29, "MARPA_ERR_NOT_TRACING_LEO_LINKS", "MARPA_ERR_NOT_TRACING_LEO_LINKS" },
  { 30, "MARPA_ERR_NOT_TRACING_TOKEN_LINKS", "MARPA_ERR_NOT_TRACING_TOKEN_LINKS" },
  { 31, "MARPA_ERR_NO_ALIAS", "MARPA_ERR_NO_ALIAS" },
  ...
  { 37, "MARPA_ERR_NO_TRACE_ES", "MARPA_ERR_NO_TRACE_ES" },
  { 38, "MARPA_ERR_NO_TRACE_PIM", "MARPA_ERR_NO_TRACE_PIM" },
  { 39, "MARPA_ERR_NO_TRACE_EIM", "MARPA_ERR_NO_TRACE_EIM" },
  { 40, "MARPA_ERR_NO_TRACE_SRCL", "MARPA_ERR_NO_TRACE_SRCL" },
  { 41, "MARPA_ERR_NULLING_TERMINAL", "A symbol is both terminal and nulling." },
  { 42, "MARPA_ERR_ORID_NEGATIVE", "MARPA_ERR_ORID_NEGATIVE" },
  { 43, "MARPA_ERR_OR_ALREADY_ORDERED", "MARPA_ERR_OR_ALREADY_ORDERED" },
  { 44, "MARPA_ERR_ORDER_FROZEN", "MARPA_ERR_ORDER_FROZEN" },
  ...
  { 48, "MARPA_ERR_PRECOMPUTED", "This grammar is precomputed." },
  { 49, "MARPA_ERR_RECCE_NOT_ACCEPTING_INPUT", "MARPA_ERR_RECCE_NOT_ACCEPTING_INPUT" },
  { 50, "MARPA_ERR_RECCE_NOT_STARTED", "MARPA_ERR_RECCE_NOT_STARTED" },
  { 51, "MARPA_ERR_RECCE_STARTED", "MARPA_ERR_RECCE_STARTED" },
  { 52, "MARPA_ERR_RHS_TOO_LONG", "MARPA_ERR_RHS_TOO_LONG" },
  { 53, "MARPA_ERR_SEQUENCE_LHS_NOT_UNIQUE", "LHS of sequence rule would not be unique." },
  { 54, "MARPA_ERR_SOURCE_TYPE_IS_NONE", "A source type of 'none' is not allowed here." },
  { 55, "MARPA_ERR_SOURCE_TYPE_IS_TOKEN", "Token source type is not allowed here." },
  { 56, "MARPA_ERR_SOURCE_TYPE_IS_COMPLETION", "Completion source type is not allowed here." },
  { 57, "MARPA_ERR_SOURCE_TYPE_IS_LEO", "Leo source type is not allowed here." },
  { 58, "MARPA_ERR_SOURCE_TYPE_IS_AMBIGUOUS", "Ambiguous source type is not allowed here." },
  { 59, "MARPA_ERR_SOURCE_TYPE_IS_UNKNOWN", "The source type is unknown." },
  { 60, "MARPA_ERR_START_NOT_LHS", "Start symbol not on LHS of any rule." },
  { 61, "MARPA_ERR_SYMIX_NEGATIVE", "MARPA_ERR_SYMIX_NEGATIVE" },
  { 62, "MARPA_ERR_SYMIX_OOB", "MARPA_ERR_SYMIX_OOB" },
  { 63, "MARPA_ERR_SYM_NOT_NULLABLE", "Symbol not nullable." },
