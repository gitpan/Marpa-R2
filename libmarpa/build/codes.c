...
const struct s_marpa_error_description marpa_error_description[] = {
  ...
  { 21, "MARPA_ERR_INVALID_RULEID", "No rule with that ID exists." },
  ...
  { 33, "MARPA_ERR_NO_ALIAS", "MARPA_ERR_NO_ALIAS" },
  { 34, "MARPA_ERR_NO_AND_NODES", "MARPA_ERR_NO_AND_NODES" },
  { 35, "MARPA_ERR_NO_OR_NODES", "MARPA_ERR_NO_OR_NODES" },
  { 36, "MARPA_ERR_NO_PARSE", "No parse." },
  { 37, "MARPA_ERR_NO_RULES", "This grammar does not have any rules." },
  { 38, "MARPA_ERR_NO_START_SYM", "This grammar has no start symbol." },
  { 39, "MARPA_ERR_NO_TRACE_ES", "MARPA_ERR_NO_TRACE_ES" },
  { 40, "MARPA_ERR_NO_TRACE_PIM", "MARPA_ERR_NO_TRACE_PIM" },
  { 41, "MARPA_ERR_NO_TRACE_EIM", "MARPA_ERR_NO_TRACE_EIM" },
  { 42, "MARPA_ERR_NO_TRACE_SRCL", "MARPA_ERR_NO_TRACE_SRCL" },
  { 43, "MARPA_ERR_NULLING_TERMINAL", "A symbol is both terminal and nulling." },
  { 44, "MARPA_ERR_ORID_NEGATIVE", "MARPA_ERR_ORID_NEGATIVE" },
  { 45, "MARPA_ERR_OR_ALREADY_ORDERED", "MARPA_ERR_OR_ALREADY_ORDERED" },
  { 46, "MARPA_ERR_ORDER_FROZEN", "MARPA_ERR_ORDER_FROZEN" },
  { 47, "MARPA_ERR_PARSE_EXHAUSTED", "MARPA_ERR_PARSE_EXHAUSTED" },
  { 48, "MARPA_ERR_PARSE_TOO_LONG", "MARPA_ERR_PARSE_TOO_LONG" },
  { 49, "MARPA_ERR_PIM_IS_NOT_LIM", "MARPA_ERR_PIM_IS_NOT_LIM" },
  ...
  { 56, "MARPA_ERR_SOURCE_TYPE_IS_NONE", "A source type of 'none' is not allowed here." },
  { 57, "MARPA_ERR_SOURCE_TYPE_IS_TOKEN", "Token source type is not allowed here." },
  { 58, "MARPA_ERR_SOURCE_TYPE_IS_COMPLETION", "Completion source type is not allowed here." },
  { 59, "MARPA_ERR_SOURCE_TYPE_IS_LEO", "Leo source type is not allowed here." },
  { 60, "MARPA_ERR_SOURCE_TYPE_IS_AMBIGUOUS", "Ambiguous source type is not allowed here." },
  { 61, "MARPA_ERR_SOURCE_TYPE_IS_UNKNOWN", "The source type is unknown." },
  { 62, "MARPA_ERR_START_NOT_LHS", "Start symbol not on LHS of any rule." },
  { 63, "MARPA_ERR_SYMIX_NEGATIVE", "MARPA_ERR_SYMIX_NEGATIVE" },
  { 64, "MARPA_ERR_SYMIX_OOB", "MARPA_ERR_SYMIX_OOB" },
  { 65, "MARPA_ERR_SYM_NOT_NULLABLE", "Symbol not nullable." },
  { 66, "MARPA_ERR_TOKEN_IS_NOT_TERMINAL", "MARPA_ERR_TOKEN_IS_NOT_TERMINAL" },
  { 67, "MARPA_ERR_TOKEN_LENGTH_LE_ZERO", "MARPA_ERR_TOKEN_LENGTH_LE_ZERO" },
  { 68, "MARPA_ERR_TOKEN_TOO_LONG", "MARPA_ERR_TOKEN_TOO_LONG" },
  { 69, "MARPA_ERR_TREE_EXHAUSTED", "MARPA_ERR_TREE_EXHAUSTED" },
  { 70, "MARPA_ERR_TREE_PAUSED", "MARPA_ERR_TREE_PAUSED" },
  { 71, "MARPA_ERR_UNKNOWN", "Unknown error." },
  { 72, "MARPA_ERR_UNPRODUCTIVE_START", "Unproductive start symbol." },
  { 73, "MARPA_ERR_VALUATOR_INACTIVE", "Valuator inactive." },
};
