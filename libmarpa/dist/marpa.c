...
#define INITIAL_R_EVENTS_CAPACITY 1
#define R_EVENTS_CLEAR(r) DSTACK_CLEAR((r) ->t_events) 
#define R_EVENT_PUSH(r) DSTACK_PUSH((r) ->t_events,REV_Object) 
...
#define MARPA_ERROR(message) (marpa_error(g,(message) ,0u) ) 
